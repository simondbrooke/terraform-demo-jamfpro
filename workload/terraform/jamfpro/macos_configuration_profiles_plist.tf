...
resource "jamfpro_macos_configuration_profile_plist" "jamfpro_macos_configuration_profile_001" {
  ...
  payloads            = file("${path.module}/support_files/dt-mcp-accessibility_hearing_base-prod-v0.0.1.mobileconfig")
...
resource "jamfpro_macos_configuration_profile_plist" "jamfpro_macos_configuration_profile_002" {
  ...
  distribution_method = "Install Automatically"
  payloads            = file("${path.module}/support_files/dt-mcp-accessibility_seeing_base-prod-v0.0.1.mobileconfig")
  category_id         = jamfpro_category.jamfpro_category_001.id
  user_removable      = false
  level               = "System"
  scope {
...
resource "jamfpro_macos_configuration_profile_plist" "jamfpro_macos_configuration_profile_003" {
  ...
  distribution_method = "Install Automatically"
  payloads            = file("${path.module}/support_files/dt-mcp-background_notifications-prod-v0.0.1.mobileconfig")
  category_id         = jamfpro_category.jamfpro_category_001.id
  user_removable      = false
  level               = "System"
  scope {
...
resource "jamfpro_macos_configuration_profile_plist" "jamfpro_macos_configuration_profile_004" {
  ...
  distribution_method = "Install Automatically"
  payloads            = file("${path.module}/support_files/dt-mcp-block_beta_updates-prod-v0.0.1.mobileconfig")
  category_id         = jamfpro_category.jamfpro_category_001.id
  user_removable      = false
  level               = "System"
  scope {
